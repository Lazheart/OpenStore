...
echo "POSTGRES_DB=${POSTGRES_DB:-openstoredb}"
echo "POSTGRES_USER=${POSTGRES_USER:-openstoreuser}"
echo "POSTGRES_PASSWORD=${POSTGRES_PASSWORD:-openstorepass}"
echo "MYSQL_HOST=$DB_HOST"
echo "MYSQL_PORT=$MYSQL_PORT_VALUE"
echo "MYSQL_DATABASE=${MYSQL_DATABASE:-shopdb}"
echo "MYSQL_USER=${MYSQL_USER:-shopuser}"
echo "MYSQL_PASSWORD=${MYSQL_PASSWORD:-shoppass}"
...
echo "export POSTGRES_PORT=$POSTGRES_PORT_VALUE"
echo "export POSTGRES_DB=${POSTGRES_DB:-openstoredb}"
echo "export POSTGRES_USER=${POSTGRES_USER:-openstoreuser}"
echo "export POSTGRES_PASSWORD=${POSTGRES_PASSWORD:-openstorepass}"
echo "export MYSQL_HOST=$DB_HOST"
echo "export MYSQL_PORT=$MYSQL_PORT_VALUE"
echo "export MYSQL_DATABASE=${MYSQL_DATABASE:-shopdb}"
echo "export MYSQL_USER=${MYSQL_USER:-shopuser}"
echo "export MYSQL_PASSWORD=${MYSQL_PASSWORD:-shoppass}"
echo "export MONGO_HOST=$DB_HOST"
echo "export MONGO_PORT=$MONGO_PORT_VALUE"
