...
def shop_update_url(shop_id: int) -> str:
	return f"{SHOP_SERVICE_URL}/shop/id/{shop_id}"


def shop_delete_url(shop_id: int) -> str:
	return f"{SHOP_SERVICE_URL}/shop/id/{shop_id}"


def shop_get_by_id_url(shop_id: int) -> str:
...
def product_delete_url(shop_id: int, product_id: str) -> str:
	return f"{PRODUCT_SERVICE_URL}/shops/{shop_id}/products/{product_id}"


def product_purge_by_shop_url(shop_id: int) -> str:
	return f"{PRODUCT_SERVICE_URL}/internal/shops/{shop_id}/products"


def shop_internal_delete_url(shop_id: int) -> str:
	return f"{SHOP_SERVICE_URL}/internal/shops/{shop_id}"


def shop_list_by_owner_url(owner_id: int) -> str:
