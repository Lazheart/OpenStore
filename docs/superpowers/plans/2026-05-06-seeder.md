...
**Goal:** Crear un script Python async que ingesta 10 tiendas con 10 owners, 200 productos y 100 usuarios normales por tienda, llamando exclusivamente al store-service de OpenStore.
