...
POSTGRES_DB_VALUE="${POSTGRES_DB:-openstoredb}"
POSTGRES_USER_VALUE="${POSTGRES_USER:-openstoreuser}"
POSTGRES_PASSWORD_VALUE="${POSTGRES_PASSWORD:-openstorepass}"
MYSQL_DATABASE_VALUE="${MYSQL_DATABASE:-shopdb}"
MYSQL_USER_VALUE="${MYSQL_USER:-shopuser}"
MYSQL_PASSWORD_VALUE="${MYSQL_PASSWORD:-shoppass}"
...
if grep -q '^USER_SERVICE_PUBLIC_URL=' .env; then
	sed -i "s|^USER_SERVICE_PUBLIC_URL=.*|USER_SERVICE_PUBLIC_URL=http://localhost:3050|" .env
else
	echo "USER_SERVICE_PUBLIC_URL=http://localhost:3050" >> .env
fi
...
echo "POSTGRES_HOST=$POSTGRES_HOST_VALUE"
echo "POSTGRES_PORT=$POSTGRES_PORT_VALUE"
...
echo "MYSQL_HOST=$MYSQL_HOST_VALUE"
echo "MYSQL_PORT=$MYSQL_PORT_VALUE"
echo "MYSQL_DATABASE=$MYSQL_DATABASE_VALUE"
echo "MYSQL_USER=$MYSQL_USER_VALUE"
echo "MYSQL_PASSWORD=$MYSQL_PASSWORD_VALUE"
echo "SHOP_DATABASE_URL=$SHOP_DATABASE_URL_VALUE"
echo "MONGO_HOST=$MONGO_HOST_VALUE"
echo "MONGO_PORT=$MONGO_PORT_VALUE"
echo "MONGO_URI=$MONGO_URI_VALUE"
echo "USER_SERVICE_PUBLIC_URL=http://localhost:3050"
